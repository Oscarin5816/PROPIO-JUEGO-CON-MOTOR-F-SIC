...
function preload()
{
  ...
  blower_img = loadImage('balloon.png');
...
function setup() {
  ...
  blink.frameDelay = 20;
  eat.frameDelay = 20;
  bunny = createSprite(1100,600,100,100);
  ...
  rope = new Rope(20,{x:780,y:60});
  rope2 = new Rope(4,{x:130,y:450});
  con = new Link(rope,fruit);
  con2 = new Link(rope2,fruit);
  rope3 = new Rope(4,{x:150,y:220});
  con3 = new Link(rope3,fruit);

  blower = createImg('balloon.png');
  blower.position(400, 550);
  blower.size(150,150);
  blower.mouseClicked(airblow);

  //botón 1
  button = createImg('cut_btn.png');
  button.position(width / 2,60);
  button.size(50,50);
  button.mouseClicked(drop);

  button2 = createImg('cut_btn.png');
  button2.position(100,420);
  button2.size(50,50);
